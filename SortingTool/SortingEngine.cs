...
namespace SortingTool
{
    internal class SortingEngine
    {
        ...
        private TaskFactory<String> _taskFactory = new TaskFactory<String>();
        ...
        private List<Task<string>> ReadAndDivideInputToTasks(BlockingCollection<String> filesList)
        {
            if(filesList == null)
                filesList = new BlockingCollection<String>();
        ...
        private Task<String> StartBatchSorting(List<HappyPanda> list)
        {            
